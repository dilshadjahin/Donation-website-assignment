            ...
            <div className=" mx-auto my-40 flex justify-center items-center flex-col text-center">
                ...
                <div className="flex items-center relative">
                    <div className="form-control flex items-center">
                        <input  onChange={(e) => setSearch(e.target.value)} type="text" placeholder="Search here" className="h-[46px] pl-4 focus:border-none border outline-[#F8F4EC] rounded-lg  focus:outline-[#F8F4EC] focus:rounded-lg w-24 md:w-full m-6" />
                    </div>
